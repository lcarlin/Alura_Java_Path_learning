...
<article id="${produto.id }" itemscope>
	<header id="product-highlight" class="clearfix">
		<div id="product-overview" class="container">
			...
			<h1 class="product-title">Titulo da Bagaça :-> ${produto.titulo}
			</h1>
			...
			<ul id="variants" class="clearfix">
				<c:forEach items="${produto.precos }" var="preco">
					<li class="buy-option" itemprop="offers" itemscope><input
						type="radio" name="tipoPreco" class="variant-radio" id="tipoPreco"
						value="${preco.tipo }" checked /> <label itemprop="category"
						itemscope class="variant-label"> ${preco.tipo} </label> <small
